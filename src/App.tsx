...
export default function App() {
  ...
  const [links, setLinks] = useState([
    ...
    {
      id: 3,
      name: 'JavaScript 全端開發',
      type: '線上課程',
      expiration: '永久',
      url: 'https://example.com/javascript-fullstack',
      status: '啟用',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      type: '推廣連結',
      expiration: '1 個月',
      url: 'https://example.com/promotion-80off',
      status: '啟用',
    },
    {
      id: 12,
      ...
      type: '推廣連結',
      expiration: '永久',
      url: 'https://example.com/new-student-gift',
      status: '啟用',
    },
    {
      id: 13,
    ...
    },
    {
      ...
      type: '線上課程',
      expiration: '已過期',
      url: 'https://example.com/old-course',
      status: '停用',
    },
  ]);
