...
export default function Sidebar() {
  ...
  return (
    <div className={`h-screen bg-background border-r border-border/50 flex flex-shrink-0 overflow-hidden ${isHomePage ? 'w-80' : 'w-20'}`} style={{ overscrollBehavior: 'none' }}>
      {/* Left Navigation Bar */}
      ...
      {/* Right Content Area - Only show on homepage */}
      {isHomePage && (
